...
namespace DominantPathsProtocols
{
	namespace NonRestartingProtocol
	{
		...
		// Description : The function Extension updates a set of candidate 
		// 				 attributes ( domTab ) to the set of attributes given 
		// 				 by the extension of a link attribute ( attrWeight ) 
		// 				 with every attribute in a set of path attributes 
		// 				 advertised ( advert ).
